...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="/adminhome" >Inicio (admin)</a></li>
					<li class="nav-item active"><a class="nav-link"
	...
	<div class="jumbotron container border border-info">
		<h3>Actualizar productos existentes</h3>
			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control border border-success" required name="name" value="${pname }" placeholder="Ingresa nombre">
					</div>
					...
					<div class="form-group">
						<label for="weight">Cantidad disponible</label> 
				...
				<div class="form-group">
						...
						<textarea class="form-control border border-success" rows="4" name="description" placeholder="Detalles del producto" value= "${ pdescription }"></textarea>
					</div>
					...
					<div class="custom-file">
						...
						<label class="custom-file-label border border-success" for="productImage">Escoger archivo</label>
