			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control border border-warning" required name="name" placeholder="Ingresa nombre">
					</div>
				...
				<div class="form-group">
						...
						<textarea class="form-control border border-warning" rows="4" name="description" placeholder="Detalles del producto..." value= "no product details"></textarea>
					</div>
					...
					<div class="custom-file">
						...
						<label class="custom-file-label border border-warning" for="productImage">Seleccionar archivo</label>
