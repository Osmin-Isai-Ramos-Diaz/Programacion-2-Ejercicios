    ...
    <div class="col-sm-6">
        ...
        <form action="updateuser" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control form-control-lg" required minlength="6" placeholder="Correo electrónico*" value="${email }" required name="email" id="email"
                       aria-describedby="emailHelp">
                <small id="emailHelp" class="form-text text-muted">Jamás compartiremos
                tu información con nadie más.</small>
            </div>
            <div class="form-group">
                <label for="password">Contraseña</label>
                <input type="password" class="form-control form-control-lg" required placeholder="Contraseña*" value="${password }" required name="password"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control form-control-lg" rows="3" placeholder="Ingrese su dirección" name="address">${address }</textarea>
            </div>
